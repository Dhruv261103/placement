...
import 'package:placement/models/app_user.dart';
...
class APIs {
  ...
  static Future<void> pushNotification(AppUser chatuser, String msg) async {
    try {
      final body = {
          ...
          await post(Uri.parse('https://fcm.googleapis.com/fcm/send'),
              headers: {
                ...
                HttpHeaders.authorizationHeader:
                    'key=AAAA0sVjVpM:APA91bFpML-clENnfLYQNdEMICz5z8zdTbCiiNl69LhBI6zZBSzy0nOdIA-yu4dlJtVloHdpjwldOduC64tDP5BbXJJIyfQjJeic9uNHQMaeY6KKqJ8_SlgmPesfLQEKXNvula8nD-ci'
              },
  ...
  static Future<void> createUser() async {
    ...
    final chatUser = AppUser(
        ...
        about: "Hey, I'm Student Of CSPIT-IT",
...
/*
  ...
  //for getting all messages of specific conversation from firebase database
    static Stream<QuerySnapshot<Map<String, dynamic>>> getAllMessages(AppUser user)
    {
  ...
  //for sending message
  static Future<void> sendMessage(AppUser chatUser,String msg,Type type) async{
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>> getLastMessage(AppUser user)
  {
    return firestore.collection('chats/${getConversationId(user.id)}/messages/')
